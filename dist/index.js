...
class AptDomain {
	...
	async getDomainRecord(domain, cb) {
		try {
			...
			try {
				domainObject.nft_meta = await this._tokenClient.getTokenData(domainObject.tokenid.token_data_id.creator, domainObject.tokenid.token_data_id.collection, domainObject.tokenid.token_data_id.name);
			} catch (e) {
